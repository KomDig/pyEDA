...
from pyEDA.autoencoder import AE, create_train_loader
from pyEDA.preprocessing import resample_data, rolling_mean
from pyEDA.statistical_features import statistical_feature_extraction, segmentwise
from pyEDA.windowing import append_dict
...
def process_statistical(
    ...
    print(
        "If you are using this tool for your research please cite this paper: "
        '"pyEDA: An Open-Source Python Toolkit for Pre-processing and Feature '
        'Extraction of Electrodermal Activity"'
    )
